...
- **EnokMethod** optimise cette énergie en injectant le _Just-in-Time Context_ (Contexte Juste-à-Temps) : uniquement les informations nécessaires à l'instant T de la tâche.
...
2.  **`MEMORY.md` (Le Cerveau Dynamique) :** L'état actuel du projet. Ce qui a été fait, ce qui est en cours, les décisions techniques récentes. Ce fichier est mis à jour _automatiquement_ par l'IA à chaque étape.
